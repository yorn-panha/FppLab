...
public class Driver {
	...
	void displayNumberOfEmployees() {
		...
		if(numEmployees>-1)
			System.out.println("Number of employees is: " +numEmployees +" (Look for other console messages.)"+n+CONTINUE);
	...
	void addCD(String cdId){
		//implement-- redo the implementation
		directory.addNewCD(Integer.parseInt(cdId));
	...
	void displayNumberOfCDsInBookstore(){
		...
		System.out.println("Number of CD's is " + numOfCDs+" (Look for console messages.)"+n+CONTINUE);
