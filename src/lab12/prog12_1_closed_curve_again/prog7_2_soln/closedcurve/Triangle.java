...
import lab12.prog12_1_closed_curve_again.exceptions.IllegalTriangleException;
...
public class Triangle extends ClosedCurve {
		...
		public Triangle(double side1, double side2, double side3) throws IllegalClosedCurveException  {
			...
			double z = arr[2];
			if(x < 0 || y < 0 || z < 0) 
				throw new IllegalClosedCurveException("An IllegalClosedCurveException was thrown in a Triangle instance");
			if(x + y < z) {
...
//				computeBaseAndHeight(DEFAULT_SIDE,DEFAULT_SIDE,DEFAULT_SIDE);
		...
		public void setSides(double x, double y, double z) throws IllegalClosedCurveException{
			if(x < 0 || y < 0 || z < 0) 
				throw new IllegalClosedCurveException("An IllegalClosedCurveException was thrown in a Triangle instance");
			if(x + y < z) 
				throw new IllegalTriangleException ("An IllegalTriangleException was thrown in a Triangle instance");
