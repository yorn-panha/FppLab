package lab6.prog6_3_redoActionListener;
...
public class StringUtilityFrame extends JFrame {
	...
	private void defineLeftPanel() {
		...
		bCount.addActionListener(evt -> {
			txtOutput.setText("" + txtInput.getText().length());
		});
		...
		bReverse.addActionListener(evt -> {
			txtOutput.setText(reverse(txtInput.getText()));
		});
		...
		bRemoveDuplicates.addActionListener(evt -> {
			txtOutput.setText(removeDuplicates(txtInput.getText()));
		});
