package lab10.prog10_3_bstsort.runtime;

import java.io.BufferedReader;
import java.io.FileReader;
import java.util.Arrays;
import java.util.Stack;
import lab10.prog10_3_bstsort.util.RandomPermutations;
import java.util.*;
...
public class SortTester {
	...
	private final int LIMITED = 0; //largest value is size of array, so no duplicate values
	...
	private final String PACKAGE = "lab10.prog10_3_bstsort.sortroutines";
	...
	public void runTests() {
		...
		while(!sorters.isEmpty()) {
			...
			String name = lab10.prog10_3_bstsort.util.Util.getClassNameNoPackage(nextSorter.getClass());
