...
public class AccountList implements Comparable<AccountList> {
	...
	@Override
	public int compareTo(AccountList o) {
		// TODO Auto-generated method stub\
//		if(this.getLargest().getBalance() < o.getLargest().getBalance()) return -1;
//		if(this.getLargest().getBalance() > o.getLargest().getBalance()) return 1;
		return 0;
	}
}
