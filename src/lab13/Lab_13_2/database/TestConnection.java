...
public class TestConnection {
	...
	static final String readquery = "SELECT id, firstname FROM Person";
	static final String insertstmt = "INSERT INTO Address(id, street, city, state, zip) " +
		"VALUES(0, '5 North Iowa Ave.', 'Fairfield', 'IA', '52556')";
